...
why it is beneficial to work with [tidy data]({{ page.root }}{% link _episodes/06-Tidy-Data.md %}).
...
[helper functions]({{ page.root }}{% link _episodes/08-Data-Verbs---select.md %}#select-helper-functions)
