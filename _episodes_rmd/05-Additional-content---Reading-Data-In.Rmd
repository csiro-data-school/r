...
[data frame]({{ page.root }}{% link _episodes/05-Dataframes.md %})-like structure and so we will 
...
[tibble format]({{ page.root }}{% link _episodes/05-Dataframes.md %}) discussed previously.
